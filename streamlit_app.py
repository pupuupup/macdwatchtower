...
st.markdown(
    ...
    ครื่องมือนี้ MACD Watchtower by pupuupup ถูกสร้างขึ้นเพื่อวัตถุประสงค์ด้านการศึกษาและการวิจัยเท่านั้น ไม่ถือเป็นคำแนะนำทางการเงิน การลงทุน หรือสัญญาณการซื้อขาย แต่อย่างใด
    ผู้ใช้งานทุกคนต้องรับผิดชอบต่อการตัดสินใจในการซื้อขายและลงทุนของตนเองทั้งหมด ผู้พัฒนาไม่รับผิดชอบต่อความเสียหายทางการเงินใด ๆ ที่อาจเกิดขึ้นจากการใช้งานแอปพลิเคชันนี้ โปรดศึกษาข้อมูลและวิเคราะห์ด้วยตนเองก่อนตัดสินใจลงทุนทุกครั้ง
    """,
